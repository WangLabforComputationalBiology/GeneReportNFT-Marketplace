...
func TestMinio(c *gin.Context) {
	// 获取对象
	object, err := configs.MinioClient.GetObject(context.Background(), "test", "1.png", minio.GetObjectOptions{})
	if err != nil {
